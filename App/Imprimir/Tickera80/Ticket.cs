...
namespace App.Imprimir.Tickera80
{
    ...
    public class Ticket
    {
        ...
        public void Imrpimir() 
        {
            ...
            l += 10;
            eg.Graphics.DrawString("IVA", fr, Brushes.Black, 0, l);
            eg.Graphics.DrawString(df.iva, fr, Brushes.Black, dder2(df.iva, fr), l);
            l += 10;
            eg.Graphics.DrawString("-".PadRight(85, '-'), fb, Brushes.Black, 0, l);
            l += 10;
            ...
            eg.Graphics.DrawString("-".PadRight(85, '-'), fb, Brushes.Black, 0, l);
            l += 10f;
            var _msg = "Documento sin Derecho a Credito Fiscal";
            eg.Graphics.DrawString(_msg, fb, Brushes.Black, centrar(_msg), l);
            l += 15;
