...
namespace App.src.Venta.CantSolicitar
{
    ...
    public partial class CantSolicitarFrm : Form
    {

        private ICantSolicitar _controlador;


        public CantSolicitarFrm()
        {
            InitializeComponent();
        }
        ...
        private void CantSolicitarFrm_Load(object sender, EventArgs e)
        {
            TB_CNT.Text = _controlador.GetCntSolicitada.ToString();
            TB_CNT.SelectAll();
            TB_CNT.Focus();
        }
        private void CantSolicitarFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
